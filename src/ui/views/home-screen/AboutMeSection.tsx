...
const AboutMeSection = (): ReactElement => {
    ...
    return (
        <div className={'bg-tertiary w-100 d-flex flex-column border-radius-top-left-50px border-radius-top-right-50px align-center'}>
            <div className={'d-flex mw-1512 pb-80px pt-80px pr-80px align-center wrap justify-center'}>
                <div className={'d-flex flex-1 flex-column p-100px gap-30 align-start justify-center min-width-300px'}>
                    <Text
